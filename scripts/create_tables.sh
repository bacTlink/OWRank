...
create table if not exists profile(battletag varchar(40) not null, season tinyint unsigned not null, hero char(16) not null, date date not null, json varchar(20000) not null, primary key (battletag, season, hero, date)) DEFAULT CHARSET=utf8;
